...
class _AddMediaDialogState extends State<AddMediaDialog> {
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _isFromFile 
                                    ? (isDark ? const Color(0xFF32B8C6) : theme.colorScheme.primary)
                                    : Colors.transparent,
                                  borderRadius: const BorderRadius.horizontal(left: Radius.circular(12)),
                                ),
                                child: Row(
                    ...
                    if (_isFromFile) ...[
                      OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                            color: isDark ? const Color(0xFF3A3F47) : theme.colorScheme.primary,
                          ),
                          foregroundColor: isDark ? Colors.white70 : theme.colorScheme.primary,
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                style: IconButton.styleFrom(
                                  backgroundColor: isDark ? const Color(0xFF1E2329) : theme.colorScheme.surface,
                                  shape: const CircleBorder(),
                                ),
                              ),
                            ],
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: isDark ? const Color(0xFF1E2329) : theme.colorScheme.surface,
      ...
      if (result != null) {
        ...
        setState(() {
          ...
          if (kIsWeb) {
            ...
            debugPrint('Web file selected: ${file.name}, bytes: ${file.bytes?.length ?? 0}');
          } else {
  ...
  void _addMedia() {
    ...
    if (!_isFromFile && _urlController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('请输入媒体链接')),
      );
      return;
    }
    ...
    debugPrint('Adding media item - Title: ${_titleController.text}, FilePath: $filePath, FileBytes: ${kIsWeb && _isFromFile ? _selectedFileBytes?.length ?? 0 : 'N/A'}');
    
    context.read<MediaBloc>().add(AddMediaItem(
      ...
      type: mediaType,
      fileBytes: kIsWeb && _isFromFile ? _selectedFileBytes : null, // Pass file bytes for web
    ));
