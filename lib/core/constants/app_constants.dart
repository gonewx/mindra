class AppConstants {
  ...
  static const List<String> defaultCategories = [
    '睡前', '专注', '放松', '冥想', '正念', '呼吸', '自然音'
  ];
  
  // Sound Effects
  static const List<String> soundEffects = [
    'rain', 'ocean', 'forest', 'wind', 'fire', 'birds', 'water'
  ];
  
  // Meditation Goals
  static const List<int> meditationGoals = [5, 10, 15, 20, 30, 45, 60]; // minutes
  
  // Reminder Times
  static const List<String> reminderTimes = [
    '06:00', '08:00', '12:00', '18:00', '20:00', '22:00'
  ];
}