...
class ConfigManager {
  ...
  static Future<void> useGitHubRawConfig({
    ...
    final baseUrl =
        'https://raw.githubusercontent.com/$repoOwner/$repoName/$branch/$docsPath';
    ...
    await setRemoteConfigUrl(
      'https://raw.githubusercontent.com/$repoOwner/$repoName/$branch/config/app_config.json',
    );
  }
